...
with open('src/pages/messages/NewMessagePage.tsx', 'r') as f:
    content = f.read()
      ...
      try {
        ...
        if (!querySnapshot.empty) {
            ...
            if (targetId && !orderId && !productId) {
               existingConv = querySnapshot.docs.find(doc => doc.data().participants.includes(targetId));
            } else {
...
with open('src/pages/messages/NewMessagePage.tsx', 'w') as f:
    f.write(replacement)
